...
with DAG(
    ...
    @task(task_id="inner_function1", doc_md="""
    ...
    @task(task_id="lotto_num_from_local_db", doc_md="""
    ...
    @task(task_id="lotto_num_from_postgres_db", doc_md="""
    ...
    @task(task_id="send_num_to_kakao", doc_md="""
    ...
    select_postgres_instance = select_postgres_task("conn-db-postgres-custom", "lotto_add_table")
